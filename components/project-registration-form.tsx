...
const DynamicProjectFormContent = dynamic(
  () => import("./ui/ProjectFormContent"),
  {
    ssr: false,
    loading: () => (
      <p className="text-center text-gray-500">Đang tải form đăng ký...</p>
    ),
  },
);
