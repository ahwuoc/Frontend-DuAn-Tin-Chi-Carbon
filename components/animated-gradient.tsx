...
export default function AnimatedGradient({ className = "" }: AnimatedGradientProps) {
  ...
  const contactText =
    language === "en" ? "Contact us for free consultation" : "Liên hệ với chúng tôi để được tư vấn miễn phí"
  ...
  return (
    <div className="relative w-full h-full">
      ...
      <div className="absolute inset-0 flex flex-col justify-center px-4 md:px-6 lg:px-8">
        <h2 className="text-xl md:text-2xl font-semibold text-white mb-3">{readyText}</h2>
